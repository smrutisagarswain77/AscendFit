...
import SplashScreen from "../components/SplashScreen"; // Immersive Fake Loading Screen Intercept
...
const Login = () => {
  ...
  const [showSplash, setShowSplash] = useState(false); // Calibration trigger tracking node
  ...
  const handleFakeSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      if (isRegistering) {
        ...
        // Intercept navigation structure with system splash sequence
        setShowSplash(true);
      }
    }, 2200);
  };
  ...
  return (
    <>
      {/* IMMERSIVE TELEMETRY LOADING DECK INTERCEPT */}
      <AnimatePresence>
        {showSplash && (
